...
class questionmodel {
 ...
 function get_by_titleanddesc($title,$desc) {
    ...
    function list_by_shangjin( $start = 0, $limit = 10) {
        $questionlist = array();
        $sql = "SELECT * FROM " . DB_TABLEPRE . "question WHERE 1=1 and  shangjin>0 order by time desc";
    ...
    function list_by_yuyin( $start = 0, $limit = 10) {
        $questionlist = array();
        $sql = "SELECT * FROM " . DB_TABLEPRE . "question WHERE 1=1 and  hasvoice>0 order by time desc";
